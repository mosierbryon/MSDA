...
set.seed(1)
lm.mod <- train(unemploymentLength~unemploymentRate+unemploymentRate12+unemploymentRate24,
                  data = allData,
                  method = "lm",
...
```{r}
rf.mod = train(unemploymentLength~unemploymentRate+unemploymentRate12+unemploymentRate24+extension,
                  data = allData,
                  method = "rf",
                  trControl = myTimeControl,
                  tuneLength=tuneLength.num,
...
```{r}
earth.mod = train(unemploymentLength~unemploymentRate+unemploymentRate12+unemploymentRate24+extension,
                  data = allData,
                  method = "earth",
                  trControl = myTimeControl,
                  tuneLength=tuneLength.num,
...
```{r}
glm.mod = train(unemploymentLength~unemploymentRate+unemploymentRate12+unemploymentRate24,
                  data = allData,
                  method = "glm",
                  trControl = myTimeControl,
                  tuneLength=tuneLength.num,
